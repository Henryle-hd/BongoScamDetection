        ...
        <div className="flex flex-col md:flex-row min-h-screen">
          ...
          <div className="md:w-1/2 flex items-center justify-center py-8 bg-gradient-to-b from-purple-50 to-white">
            <div className="text-center max-w-2xl px-8">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-600 tracking-tight mb-8 hover:scale-105 transition-transform duration-300">
                SMS CHECKER
              </h2>
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-purple-100 hover:shadow-2xl transition-all duration-300 mb-8">
                ...
                <br /><br />
                To address this problem, I created a dataset of 1,000 Tanzania Swahili-based SMS examples, showcasing various scam patterns. The dataset is available on <a href="https://www.kaggle.com/datasets/henrydioniz/swahili-sms-detection-dataset/data" className="text-purple-600 hover:text-purple-800 underline">Kaggle</a>, and this project also includes a basic machine learning model to detect and predict such fraudulent messages.
                </p>
            </div>
            {/* <div className="bg-purple-50 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="mt-8 space-y-4">
                ...
                <a href="https://www.kaggle.com/datasets/henrydioniz/swahili-sms-detection-dataset/data" target="_blank" rel="noopener noreferrer" className="block px-8 py-4 bg-white text-purple-600 rounded-full font-bold border-2 border-purple-600 hover:bg-purple-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
        ...
        <div className="md:w-1/2 container max-w-md mx-auto mt-10 px-4 pb-8">
            {!prediction}
              <div className="mb-8 transform hover:scale-102 transition-all duration-300">
                  ...
                  <form onSubmit={handleSubmit} className="flex items-center gap-3 bg-white p-4 rounded-3xl shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-300 ">
                      <input
                      ...
                      <button
                          title='send'
                          type="submit"
                          className="rounded-3xl w-14 h-14 flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-indigo-600 hover:to-purple-600 text-white transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                      >
                        <Send size={24} />
                      </button>
                  </form>
                                      ...
                                      <div className={`mt-4 mb-6 rounded-2xl p-6 border shadow-lg transition-all duration-300 hover:shadow-xl ${message.text === 'scam' ? 'bg-red-50 border-red-200' : 'bg-green-50 border-green-200'}`}>
                                          <div className="flex items-center">
                                              ...
                                              <h3 className="ml-4 font-bold text-lg">
                                                  {message.text === 'scam' ? 'Ujumbe wa Uwizi!' : 'Ujumbe Salama'}
                                              </h3>
                                          </div>
